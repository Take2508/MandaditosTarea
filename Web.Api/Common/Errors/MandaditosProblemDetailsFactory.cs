...
public class MandaditosProblemDetailsFactory : ProblemDetailsFactory
{
        ...
        string? instance = null)
    {
        ...
        ApplyProblemsDetailsDefault(httpContext, problemDetails, statusCode.Value);
    ...
    private void ApplyProblemsDetailsDefault(HttpContext httpContext, ProblemDetails problemDetails, int statusCode)
    {
